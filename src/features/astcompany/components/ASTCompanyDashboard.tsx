...
export default function ASTCompanyDashboard() {
      ...
      <aside className="hidden lg:flex w-64 flex-col bg-slate-900 text-white">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-lg font-bold">AST Company</h1>
              <span className="text-xs text-emerald-400 uppercase tracking-wider">Studio</span>
            </div>
          </div>
        </div>
      </aside>
