...
export default function ASTCompanyDashboard({ bu }: ASTCompanyDashboardProps) {
  ...
  useEffect(() => {
    const checkUser = async () => {
      ...
      // AST 사업부가 아니고 본사도 아닌 경우 접근 불가
      if (appUser?.bu_code && appUser.bu_code !== 'AST' && appUser.bu_code !== 'HEAD') {
        // 본인 사업부 ERP로 리디렉션
      ...
      <ModalActions
        onPrimary={() =>
          onSubmit({
            ...
            status: form.status,
            last_meeting_date: form.last_meeting_date || undefined,
            business_registration_file: form.business_registration_file || undefined,
          } as any)
        }
        onClose={onClose}
        primaryLabel="등록"
      ...
      <ModalActions
        onPrimary={() =>
          onSubmit({
            ...
            business_card_file: form.business_card_file || undefined,
          })
        }
        onClose={onClose}
        primaryLabel="수정"
