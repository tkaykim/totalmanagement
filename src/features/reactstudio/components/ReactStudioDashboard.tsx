...
export default function ReactStudioDashboard() {
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 bg-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-xl">
              R
                              ...
                              <div>
              <h1 className="text-lg font-bold">React Studio</h1>
              <span className="text-xs text-purple-400 uppercase tracking-wider">Creative</span>
                                </div>
                              </div>
                            </div>
      </aside>
