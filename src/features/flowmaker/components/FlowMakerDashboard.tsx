...
export default function FlowMakerDashboard() {
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="w-10 h-10 bg-cyan-600 rounded-xl flex items-center justify-center text-white font-bold text-xl">
              F
                              ...
                              <div>
              <h1 className="text-lg font-bold">Flow Maker</h1>
              <span className="text-xs text-cyan-400 uppercase tracking-wider">Production</span>
                                </div>
                              </div>
                            </div>
      </aside>
